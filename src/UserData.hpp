#ifndef RWLIB_USERDATA_
#define RWLIB_USERDATA_
...
struct UserDataArray {
    ...
    int32 getInt(int32 n) {
        return ((int32 *)this->data)[n];
    }
    float32 getFloat(int32 n) {
        return ((float32 *)this->data)[n];
    }
    char *getString(int32 n) {
        return ((char **)this->data)[n];
    }
    void setInt(int32 n, int32 i) {
        ((int32 *)this->data)[n] = i;
    }
    void setFloat(int32 n, float32 f) {
        ((float32 *)this->data)[n] = f;
    }
    void setString(int32 n, const char *s);

    static int32 geometryAdd(Geometry *g, const char *name, int32 datatype,
                             int32 numElements);
    ...
    static int32 frameAdd(Frame *f, const char *name, int32 datatype,
                          int32 numElements);
    ...
    static int32 cameraAdd(Camera *c, const char *name, int32 datatype,
                           int32 numElements);
    ...
    static int32 lightAdd(Light *l, const char *name, int32 datatype,
                          int32 numElements);
    ...
    static int32 materialAdd(Material *m, const char *name, int32 datatype,
                             int32 numElements);
    ...
    static int32 textureAdd(Texture *t, const char *name, int32 datatype,
                            int32 numElements);
