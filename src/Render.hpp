#ifndef RWLIB_RENDER_
#define RWLIB_RENDER_
...
enum AlphaTestFunc { ALPHAALWAYS = 0, ALPHAGREATEREQUAL, ALPHALESS };

enum CullMode { CULLNONE, CULLBACK, CULLFRONT };
...
void RenderTriangle(void *verts, int32 numVerts, int32 vert1, int32 vert2,
                    int32 vert3);
void RenderIndexedPrimitive(PrimitiveType, void *verts, int32 numVerts,
